...
É o diagrama utilizado para representar visualmente o banco de dados.
...
- Cada matrícula pertence a apenas um aluno e um curso.
...
- ITEM_PEDIDO resolve o relacionamento N:N.
...
erDiagram
    ...
    ALUNO }o--|| PLANO : possui

    PROFESSOR ||--o{ TREINO : cria
...
✔ Utilizar nomes claros para entidades

✔ Criar PK em todas as tabelas
...
❌ Criar uma única tabela para todo o sistema

❌ Não utilizar PK

❌ Não resolver relacionamentos N:N
...
Na próxima aula transformaremos os modelos criados hoje em tabelas reais utilizando SQL.
...
Chegou a hora de transformar a modelagem em um banco de dados de verdade.
